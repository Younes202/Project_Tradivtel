"""
Django's settings for Tradivtel project.
...
SECRET_KEY = 'django-insecure-(nk@u)g57xfz3+ixuxsqkua_2ek%tlwg5jd#@s31k$vm(rp0f4'
...
WSGI_APPLICATION = 'Tradivtel.wsgi.application'
